package me.StevenLawrence.TotalFreedomMod.Commands;

import java.util.Random;
import me.StevenLawrence.TotalFreedomMod.TFM_Util;
import me.StevenLawrence.TotalFreedomMod.TotalFreedomMod;
